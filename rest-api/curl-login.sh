...
# curl --cert ./incus-api.crt --key ./incus-api.key -k https://192.168.1.81:8443/1.0/events
curl --cert ./incus-api.crt --key ./incus-api.key -k https://192.168.1.81:8443/1.0/resources
